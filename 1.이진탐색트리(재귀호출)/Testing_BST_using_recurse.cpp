...
int main()
{
	...
	*/
	...
	/*	(테스팅 결과)
		...
		BST 복사 삽입에는 22.8초가 걸렸고, 비교용 std::map 복사 삽입에는 27.8초가 걸렸음
		BST 이동 삽입에는 21.6초가 걸렸고, 비교용 std::map 이동 삽입에는 28.8초가 걸렸음
		BST 검색에는 19.2초가 걸렸고, 비교용 std::map 검색에는 20.2초가 걸렸음
		BST 삭제에는 35.3초가 걸렸고, 비교용 std::map 삭제에는 29.3초가 걸렸음
	*/
