...
int main()
{
	...
	*/
	...
	/*	(테스팅 결과)
		...
		BST 복사 삽입에는 31.0초가 걸렸고, 비교용 std::map 복사 삽입에는 30.3초가 걸렸음
		BST 이동 삽입에는 30.6초가 걸렸고, 비교용 std::map 이동 삽입에는 27.0초가 걸렸음
		BST 검색에는 19.8초가 걸렸고, 비교용 std::map 검색에는 22.6초가 걸렸음
		BST 삭제에는 35.3초가 걸렸고, 비교용 std::map 삭제에는 33.0초가 걸렸음
	*/
