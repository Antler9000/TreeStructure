...
int main()
{
	...
	*/
	...
	/*	(테스팅 결과)
		...
		검색		: BST = 19.3초	|	std::map = 24.5초
		삭제		: BST = 33.6초	|	std::map = 34.2초
		소멸		: BST = 25.4초	|	std::map = 21.7초
	*/
	...
	*/
	...
	/*	(테스팅 결과)
		...
		검색		: BST = 31.8초	|	std::map = 0.03초
		삭제		: BST = 00.3초	|	std::map = 0.08초
		소멸		: BST = 117.9초	|	std::map = 0.04초
	*/
