...
int main()
{
	...
	*/
	...
	/*	(테스팅 결과)
		...
		복사 삽입	: BST = 23.3초	|	std::map = 25.5초
		이동 삽입	: BST = 23.4초	|	std::map = 23.3초
		검색		: BST = 17.7초	|	std::map = 19.2초
		삭제		: BST = 33.0초	|	std::map = 28.3초
		소멸		: BST = 15.0초	|	std::map = 19.4초
	*/
	...
	*/
	...
	/*	(테스팅 결과)
		...
		복사 삽입	: BST = 34.6초	|	std::map = 0.10초
		이동 삽입	: BST = 31.5초	|	std::map = 0.08초
		검색		: BST = 34.0초	|	std::map = 0.03초
